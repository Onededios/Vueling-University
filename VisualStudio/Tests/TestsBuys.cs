...
using Vueling.Auto.Template.Tests;

namespace Onededios.Testing.WebPages.Tests
{
    [TestFixture]
    class TestsBuys : TestSetCleanBase
    {
        [TestCase]
        public void modalContactTesting()
        {
            ...
            //test.Log(Status.Info, "The modal has been opened.");
